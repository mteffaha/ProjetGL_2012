...
public class configSimu extends JFrame {
	...
	public configSimu() {
		...
		tabbedPane.addTab("Hasard", icon, hasard, "parametre de bebetes hasard");
		tabbedPane.setMnemonicAt(1, KeyEvent.VK_2);
		// troisiéme onglet pour configurer les bebers Emergentes
		JComponent emerg = PanelConfigEmerg();
		tabbedPane.addTab("Emergente", icon, emerg, "parametre de bebetes Emergentes");
	...
	private JComponent PanelConfigEmerg() {
		...
		dist.setToolTipText("distance minimale entre deux bebetes pour changer leurs direction et vitesse");
	...
	// creation de panneau de confiquration des bebetes hasard
	...
	public JComponent PanelConfigGen() {
		...
		bg.add(hasr);
		bg.add(emer);
		comp = new JLabel("type des bebetes : ");
		config.add(comp);
