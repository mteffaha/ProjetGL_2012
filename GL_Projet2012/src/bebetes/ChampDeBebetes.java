...
public class ChampDeBebetes extends VisualisateurAnime { 
	...
	protected int nbB; // nombre de bébêtes
	...
	// Séparation de la construction des éléments
	protected void initialiseElements() {
		...
		// initialisation des Dessinables (propagée dans le simulateur par filtrage)
		setDessinables(ld);
	}
	...
	public void setDessinables(List<? extends Dessinable> dessinables) {
		...
		// 2. ni faire un controle comme ci-desous (les paramètres de généricité sont effacés) 
